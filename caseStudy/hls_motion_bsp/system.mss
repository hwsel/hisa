...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_bram_aux
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_frame
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_mean0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_mean1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_mean2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_outmask
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_varsum
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.03.a
 PARAMETER HW_INSTANCE = axi_bram_weight
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = hls_macc_top
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = hls_macc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mog_algorithm_block_top
 PARAMETER DRIVER_VER = 1.40.a
 PARAMETER HW_INSTANCE = mog_algorithm_block_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 4.00.a
 PARAMETER HW_INSTANCE = v_tc_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ycrcb2rgb
 PARAMETER DRIVER_VER = 5.01.a
 PARAMETER HW_INSTANCE = v_ycrcb2rgb_0
END
