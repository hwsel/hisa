...
volatile Xuint8 *backupframeA = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+3*offset);
    volatile Xuint8 *backupframeB = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+4*offset);
    volatile Xuint8 *backupframeC = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+5*offset);
    volatile Xuint8 *backupframeD = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+6*offset);
    volatile Xuint8 *backupframeE = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+7*offset);
    volatile Xuint8 *backupframeF = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+8*offset);
    volatile Xuint8 *outframeB = (Xuint8 *)(pDemo->uBaseAddr_MEM_HdmiFrameBuffer+9*offset);
...
count_hls++;
		if(count_hls==10)
                     {
                        memcpy_cus(backupframeA, output_frame, storage_size);
                     }
                   if(count_hls==11)
                     {
                        memcpy_cus(backupframeB, output_frame, storage_size);
                     }
                   if(count_hls==12)
                     {
                        memcpy_cus(backupframeC, output_frame, storage_size);
                     }
                   if(count_hls==13)
                     {
                        memcpy_cus(backupframeD, output_frame, storage_size);
                     }
                   if(count_hls==14)
                     {
                        memcpy_cus(backupframeE, output_frame, storage_size);
                     }
                   if(count_hls==15)
                     {
                        memcpy_cus(backupframeF, output_frame, storage_size);
                     }
                   //==============================attack  hardware  =======================
            if(count_hls>=20) // attack
            {
                   switch(flag)
                   {
                        case 0: {XHls_macc_SetB(&HlsMacc, backupframeA);flag=1;break;}
                        case 1: {XHls_macc_SetB(&HlsMacc, backupframeB);flag=2;break;}
                        case 2: {XHls_macc_SetB(&HlsMacc, backupframeC);flag=3;break;}
                        case 3: {XHls_macc_SetB(&HlsMacc, backupframeD);flag=4;break;}
                        case 4: {XHls_macc_SetB(&HlsMacc, backupframeE);flag=5;break;}
                        case 5: {XHls_macc_SetB(&HlsMacc, backupframeF);flag=0;break;}
                    }
